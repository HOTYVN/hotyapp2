...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/emoji_keyboard_flutter/emoji_keyboard_flutter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_naver_login/flutter_naver_login.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/kakao_flutter_sdk_common/kakao_flutter_sdk_common.framework"
